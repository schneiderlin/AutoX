...
class JsConsole(val console: Console) : ScriptableObject() {
    ...
    companion object {
         ...
         */
        @JvmStatic
        fun log(context: Context, thisObj: Scriptable, args: Array<Any?>, funObj: Function): Any? {
         ...
         */
        @JvmStatic
        fun info(context: Context, thisObj: Scriptable, args: Array<Any?>, funObj: Function): Any? {
            val message = formatArgs(args)
            val jsConsole = thisObj as? JsConsole
         ...
         */
        @JvmStatic
        fun warn(context: Context, thisObj: Scriptable, args: Array<Any?>, funObj: Function): Any? {
            val message = formatArgs(args)
            val jsConsole = thisObj as? JsConsole
         ...
         */
        @JvmStatic
        fun error(context: Context, thisObj: Scriptable, args: Array<Any?>, funObj: Function): Any? {
            val message = formatArgs(args)
            val jsConsole = thisObj as? JsConsole
